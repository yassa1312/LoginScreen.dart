...
class PreferenceUtils {
  ...
  static Future<void> saveCredentials(String email, String password) async {
    await setString(PrefKeys.email, email);
    await setString(PrefKeys.password, password);
  }

  static String getEmail() {
    return getString(PrefKeys.email);
  }

  static String getPassword() {
    return getString(PrefKeys.password);
  }

}
// Saving user data
void saveUserData(String userData) async {
  await PreferenceUtils.setString(PrefKeys.userData, userData);
}

// Retrieving user data
void getUserData() {
  String userData = PreferenceUtils.getString(PrefKeys.userData);
